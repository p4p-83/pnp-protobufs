# Autogenerated using ProtoBuf.jl v1.0.15 on 2024-09-14T16:06:41.425
# original file: /Users/james/Developer/uoa/p4/p4p/controller/src/proto/pnp/v1/pnp.proto (proto3 syntax)
...
export var"Message.Position", var"Message.Step", var"Message.Calibration"
...
struct Message
    ...
    payload::Union{Nothing,OneOf{<:Union{var"Message.Deltas",var"Message.Positions",var"Message.Step",var"Message.Calibration"}}}
end
PB.oneof_field_types(::Type{Message}) = (;
    payload = (;deltas=var"Message.Deltas", positions=var"Message.Positions", step=var"Message.Step", calibration=var"Message.Calibration"),
)
PB.default_values(::Type{Message}) = (;tag = var"Message.Tags".INVALID, deltas = nothing, positions = nothing, step = nothing, calibration = nothing)
PB.field_numbers(::Type{Message}) = (;tag = 1, deltas = 2, positions = 3, step = 4, calibration = 5)
