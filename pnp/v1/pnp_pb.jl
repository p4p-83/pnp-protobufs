# Autogenerated using ProtoBuf.jl v1.0.15 on 2024-09-21T16:30:12.556
...
export var"Message.HeadOperation.Operation", var"Message.Position", var"Message.Step"
export var"Message.Calibration", var"Message.HeadOperation", var"Message.Positions"
export Message
...
@enumx var"Message.Tags" INVALID=0 HEARTBEAT=1 TARGET_DELTAS=2 MOVED_DELTAS=3 TARGET_POSITIONS=4 STEP_GANTRY=5 CALIBRATE_DELTAS=6 OPERATE_HEAD=7
...
struct Message
    ...
    payload::Union{Nothing,OneOf{<:Union{var"Message.Deltas",var"Message.Positions",var"Message.Step",var"Message.Calibration",var"Message.HeadOperation"}}}
end
PB.oneof_field_types(::Type{Message}) = (;
    payload = (;deltas=var"Message.Deltas", positions=var"Message.Positions", step=var"Message.Step", calibration=var"Message.Calibration", headOperation=var"Message.HeadOperation"),
)
PB.default_values(::Type{Message}) = (;tag = var"Message.Tags".INVALID, deltas = nothing, positions = nothing, step = nothing, calibration = nothing, headOperation = nothing)
PB.field_numbers(::Type{Message}) = (;tag = 1, deltas = 2, positions = 3, step = 4, calibration = 5, headOperation = 6)
