# Autogenerated using ProtoBuf.jl v1.0.15 on 2024-09-22T18:44:28.227
...
export var"Message.HeadOperation.Operation", var"Message.NozzleRotation"
export var"Message.Position", var"Message.Step.Direction", var"Message.Deltas"
export var"Message.Tags", var"Message.HeadOperation", var"Message.Positions"
export var"Message.MachineState", var"Message.Step", var"Message.Calibration", Message

@enumx var"Message.HeadOperation.Operation" PICK=0 PLACE=1 ENGAGE_VACUUM=2 DISENGAGE_VACUUM=3 LOWER_HEAD=4 RAISE_HEAD=5

struct var"Message.NozzleRotation"
    degrees::Int32
end
PB.default_values(::Type{var"Message.NozzleRotation"}) = (;degrees = zero(Int32))
PB.field_numbers(::Type{var"Message.NozzleRotation"}) = (;degrees = 1)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Message.NozzleRotation"})
    degrees = zero(Int32)
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            degrees = PB.decode(d, Int32, Val{:zigzag})
        else
            PB.skip(d, wire_type)
        end
    end
    return var"Message.NozzleRotation"(degrees)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::var"Message.NozzleRotation")
    initpos = position(e.io)
    x.degrees != zero(Int32) && PB.encode(e, 1, x.degrees, Val{:zigzag})
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"Message.NozzleRotation")
    encoded_size = 0
    x.degrees != zero(Int32) && (encoded_size += PB._encoded_size(x.degrees, 1, Val{:zigzag}))
    return encoded_size
end
...
@enumx var"Message.Tags" INVALID=0 HEARTBEAT=1 TARGET_DELTAS=2 MOVED_DELTAS=3 TARGET_POSITIONS=4 STEP_GANTRY=5 CALIBRATE_DELTAS=6 OPERATE_HEAD=7 MACHINE_STATE=8 ROTATE_NOZZLE=9
...
struct Message
    ...
    payload::Union{Nothing,OneOf{<:Union{var"Message.Deltas",var"Message.Positions",var"Message.Step",var"Message.Calibration",var"Message.HeadOperation",var"Message.MachineState",var"Message.NozzleRotation"}}}
end
PB.oneof_field_types(::Type{Message}) = (;
    payload = (;deltas=var"Message.Deltas", positions=var"Message.Positions", step=var"Message.Step", calibration=var"Message.Calibration", headOperation=var"Message.HeadOperation", machineState=var"Message.MachineState", nozzleRotation=var"Message.NozzleRotation"),
)
PB.default_values(::Type{Message}) = (;tag = var"Message.Tags".INVALID, deltas = nothing, positions = nothing, step = nothing, calibration = nothing, headOperation = nothing, machineState = nothing, nozzleRotation = nothing)
PB.field_numbers(::Type{Message}) = (;tag = 1, deltas = 2, positions = 3, step = 4, calibration = 5, headOperation = 6, machineState = 7, nozzleRotation = 8)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Message})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 8
            payload = OneOf(:nozzleRotation, PB.decode(d, Ref{var"Message.NozzleRotation"}))
        else
            PB.skip(d, wire_type)
        end
    end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::Message)
    ...
    elseif x.payload.name === :nozzleRotation
        PB.encode(e, 8, x.payload[]::var"Message.NozzleRotation")
    end
    return position(e.io) - initpos
end
function PB._encoded_size(x::Message)
    ...
    elseif x.payload.name === :nozzleRotation
        encoded_size += PB._encoded_size(x.payload[]::var"Message.NozzleRotation", 8)
    end
    return encoded_size
end
